...
public class HashingTrickFilterBinary1 extends AbstractStreamFilter {
    ...
    protected InstanceExample nextInstance  ;
    
   
@Override
    protected void restartImpl() {
        this.nextInstance = getInstance();
    }
    ...
    public InstanceExample nextInstance() {
        Instance returnInstance = (Instance) this.nextInstance;
        this.nextInstance = getInstance();
        return (InstanceExample) returnInstance;
    }

    protected InstanceExample getInstance(){
    ...
    public DenseInstance transformedInstance(Instance sparseInst, int [] hashVal) {
